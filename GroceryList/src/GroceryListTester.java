	...
	public static void test01()
	{
		...
		try
		{
			...
			while (fileScanner.hasNextLine())
			{
				...
				if (splitLines.length != FIELD_AMT) continue;// If not then skip
																// it
				// Otherwise create a new Grocery Item from the data in split
				// line
				String name = splitLines[0];
				double value = Double.parseDouble(splitLines[1]);// Converts the
																	// String
																	// value to
																	// a double
																	// value
