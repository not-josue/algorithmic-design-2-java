...
public class WordSorterFrontEnd
{
	...
	// The file name to be read in the program's root directory. Be mindful that
	// the program's directory is often times not the source directory
	...
	/**
	 * Returns an array of strings that correspond to words found line-by-line
	 * in a file
	 * 
	 * @param fileName
	...
	public static String[] readFile(String fileName)
	{
		try
		{
			...
			// Creates the return array, resets the file scanner, and populates
			// the array
	 ...
	 * 
	 * @param words
	 *            an array of words to be printed to the console
	 */
